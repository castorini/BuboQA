...
python scripts/create_inverted_index_entity.py -n data/freebase_names/names.trimmed.2M.txt -p indexes/entity_2M.pkl

# echo "\n\nCreate the inverted index for entity names for 5M-freebase-subset...\n"
# python scripts/create_inverted_index_entity.py -n data/freebase_names/names.trimmed.5M.txt -p indexes/entity_5M.pkl

echo "\n\nCreate the index for degree counts for 2M-freebase-subset...\n"
python scripts/create_index_degrees.py -s data/SimpleQuestions_v2/freebase-subsets/freebase-FB2M.txt -p indexes/degrees_2M.pkl

# echo "\n\nCreate the index for degree counts for 5M-freebase-subset...\n"
# python scripts/create_index_degrees.py -s data/SimpleQuestions_v2/freebase-subsets/freebase-FB5M.txt -p indexes/degrees_5M.pkl

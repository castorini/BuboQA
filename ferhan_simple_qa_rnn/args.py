...
def get_args():
    ...
    parser.add_argument('--data_cache', type=str, default=os.path.join(os.getcwd(), 'relation_prediction/data_cache'))
    parser.add_argument('--vector_cache', type=str, default=os.path.join(os.getcwd(), 'relation_prediction/vector_cache/input_vectors.pt'))
    parser.add_argument('--ent_data_cache', type=str, default=os.path.join(os.getcwd(), 'entity_detection/data_cache'))
    parser.add_argument('--ent_vector_cache', type=str, default=os.path.join(os.getcwd(), 'entity_detection/vector_cache/input_vectors.pt'))
    ...
    parser.add_argument('--trained_model', type=str, default='relation_prediction/model/rel_model.pt')
    parser.add_argument('--ent_trained_model', type=str, default='entity_detection/model/ent_model.pt')
